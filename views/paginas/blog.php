<main class="contenedor seccion contenido-centrado">
    ...
    <article class="entrada-blog">
        ...
        <div class="texto-entrada">
            <a href="/entrada">
                ...
                <p class="informacion-meta">Escrito el: <span>17/09/2025</span> por: <span>Admin</span> </p>
    ...
    <article class="entrada-blog">
        <div class="imagen">
            <picture>
                <source srcset="build/img/webp/blog3.webp" type="image/webp">
    ...
    <article class="entrada-blog">
        <div class="imagen">
            <picture>
                <source srcset="build/img/webp/blog4.webp" type="image/webp">
